<template>
    ...
    <Box additionalClass="col-span-3 border border-orange-500 mb-5">
      <div class="flex justify-center">
        ...
        <p v-else class="text-indigo-900 text-center">
          ...
          <TButton @click="parkingZoneStore.fetchZones(true)" color="green">
            reload zones
          </TButton>
        </p>
      </div>
  ...
  <BaseContainer>
    <Box additionalClass="col-span-3 p-0 mb-6">
      ...
      <div v-if="showForm" class="py-6 px-6 md:py-10 md:px-10">
...
const helpMessage = `
<ul>
  <li>Creating a new zone is only possible for entitled wallets.</li>
  <li>The list is filtered by wallet by default.</li>
  <li>The zone is based on the premade GeoJSON file.</li>
  <li>Please note that the owner's wallet will get all of the rights to the zone (withdraw funds, delete the zone).</li>
</ul>`;
</script>
