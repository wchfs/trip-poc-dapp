    ...
    <Box additionalClass="col-span-3 border border-indigo-600 mb-5">
      <div class="flex justify-center">
        ...
        <p v-else class="text-indigo-900 text-center">
          ...
          <TButton @click="voucherStore.fetchVouchers(true)" color="green">
            reload vouchers
          </TButton>
        </p>
      </div>
...
const helpMessage = `
<ul>
  <li>The vouchers tab is the place where those can be executed.</li>
  <li>Pending status informs that voucher is generated successfully.</li>
  <li>The process of confirming the ticket can take as long as one week.</li>
  <li>Approved status indicated that proofs are generated and vouchers can be safely executed.</li>
  <li>After execution, ether should just appear on the wallet.</li>
</ul>
`;
</script>
