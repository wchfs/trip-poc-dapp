...
pub fn withdraw_funds(
    ...
    let uint_parsed_token = ethabi::ethereum_types::U256::from_dec_str(&withdraw_struct.amount)?;
    
    let amount_token = ethabi::Token::Uint(uint_parsed_token * GWEI_TO_WEI_FACTOR);
